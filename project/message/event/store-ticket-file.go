...
func (h MessageHandler) StoreTicketFile(ctx context.Context, event *entities.TicketBookingConfirmed) error {
...
<body>
	...
	ticketPrintedEvent := entities.NewTicketPrinted(event.TicketID, fileID)
